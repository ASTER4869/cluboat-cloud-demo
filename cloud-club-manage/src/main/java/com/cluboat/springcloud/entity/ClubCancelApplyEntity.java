...
public class ClubCancelApplyEntity {
    ...
    public void setCancelApply(ClubCancelApplyParam clubCancelApplyParam) {
        this.cancelApplyReason= clubCancelApplyParam.cancelApplyReason;
        this.cancelApplyTime = clubCancelApplyParam.cancelApplyTime;
        this.clubId = clubCancelApplyParam.clubId;
        this.userId = clubCancelApplyParam.userId;
    }
